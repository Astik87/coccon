...
<form action="<?= POST_FORM_ACTION_URI ?>" method="post" id="asd_subscribe_form" class="mailing-form">
	<?= bitrix_sessid_post() ?>
	...
	<input type="email" name="asd_email" placeholder="Ваш E-mail" value="" id="email" />
