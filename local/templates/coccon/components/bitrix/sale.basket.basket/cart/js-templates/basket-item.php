...
<script id="basket-item-template" type="text/html">
	<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}} {{PRE_ORDER}}" id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}">
		{{#SHOW_RESTORE}}
			...
			<div class="basket-item-block-info">
				...
				?>
					<span class="basket-item-actions-remove visible-xs" data-entity="basket-item-delete">
						<svg>
							<use xlink:href="<?= TEMPLATE_PATH ?>/assets/img/sprite.svg#remove"> </use>
						</svg>
					</span>
				<?
				}
				...
				?>
							...
							?>
								{{#COLUMN_LIST}}
									...
									{{#IS_TEXT}}
										<div class="basket-item-property-custom artnumber basket-item-property-custom-text
														{{#HIDE_MOBILE}}hidden-xs{{/HIDE_MOBILE}}" data-entity="basket-item-property">
											<div class="basket-item-property-custom-name artnumber">{{NAME}}</div>
											<div class="basket-item-property-custom-value artnumber" data-column-property-code="{{CODE}}" data-entity="basket-item-property-column-value">
												{{VALUE}}
											</div>
										</div>
									{{/IS_TEXT}}
