...
if ($_GET['sort'] == 'catalog_PRICE_desc') {
	$_GET['sort'] = 'catalog_PRICE_1';
	$_GET['method'] = 'desc';
}

if ($_GET['sort'] == 'catalog_PRICE_asc') {
	$_GET['sort'] = 'catalog_PRICE_1';
	$_GET['method'] = 'asc';
}
...
?><? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"ELEMENT_SORT_FIELD" => !$_GET["sort"]?"SHOW_COUNTER":$_GET["sort"],
		"ELEMENT_SORT_ORDER" => !$_GET["method"]?"desc":$_GET["method"],
